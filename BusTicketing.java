...
public class BusTicketing extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBoxDestination.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Destination", "KSRTC", "Jabbar", "SRT", "TannaBus", "ZingBus", "Amtrak", "Attur", "Relus", "VTSRBus", "Manjus", "TKS", "sps", "Vinjus", "MKS", "VNS", " ", " ", " " }));
    ...
    private void jButtonTotalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTotalActionPerformed
       ...
       if(jComboBoxDestination.getSelectedItem().equals("KSRTC") || jRadioButtonFirstClass1.isSelected()|| jRadioButtonReturn1.isSelected()||
               jRadioButtonEconomy1.isSelected()||
       ...
       jTextFieldForm.setText("Madurai");
       ...
       jTextFieldTicketType.setText(null);
        ...
        else if(jComboBoxDestination.getSelectedItem().equals("Jabbar") || jRadioButtonFirstClass1.isSelected()|| jRadioButtonReturn1.isSelected()||
               jRadioButtonEconomy1.isSelected()||
               jRadioButtonSingle1.isSelected()|| (!(jTextFieldPassenger1.getText()== null) )){
          int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
      
       jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("Madurai");
       jTextFieldClass.setText("Economy");
        jTextFieldClass.setText("First Class");
       jTextFieldTicketType.setText("One Way");
       
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("Chennai");
       ...
       jTextFieldTicketType.setText(null);
        ...
        else if(jComboBoxDestination.getSelectedItem().equals("SRT") || jRadioButtonFirstClass1.isSelected()|| jRadioButtonReturn1.isSelected()||
               jRadioButtonEconomy1.isSelected()||
               jRadioButtonSingle1.isSelected()||(!(jTextFieldPassenger1.getText()== null)) ){
           int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
     
       jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("Tenkasi");
       jTextFieldClass.setText("First Class");
       ...
       jTextFieldTicketType.setText(null);
        ...
        else if(jComboBoxDestination.getSelectedItem().equals("TannaBus") || jRadioButtonFirstClass1.isSelected()|| jRadioButtonReturn1.isSelected()||
               jRadioButtonEconomy1.isSelected()||
               jRadioButtonSingle1.isSelected()|| (!(jTextFieldPassenger1.getText()== null) )){
          int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
       ...
       jTextFieldTicketType.setText("Round Trip");
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("Tenkasi");
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("ZingBus")|| jRadioButtonFirstClass1.isSelected()|| jRadioButtonReturn1.isSelected()||
               jRadioButtonEconomy1.isSelected()||
               jRadioButtonSingle1.isSelected()|| (!(jTextFieldPassenger1.getText()== null) )){
     int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
     
      jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("Coimbatore");
       jTextFieldClass.setText("Economy");
       jTextFieldTicketType.setText("One Way");       
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("Theni");
              miles = 4;
           Tfare= miles*fare;
           Dtax = (Tax*Tfare)/100;
           SubTotal = (Dtax + Tfare)*Pass;
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("Amtrak") || jRadioButtonFirstClass1.isSelected()|| jRadioButtonReturn1.isSelected()||
               jRadioButtonEconomy1.isSelected()||
               jRadioButtonSingle1.isSelected()|| (!(jTextFieldPassenger1.getText()== null) ) ){
           int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
       ...
       jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
       jTextFieldTo.setText("Tirunelveli");
       jTextFieldClass.setText("First Class");
       jTextFieldTicketType.setText("One Way");
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
       jTextFieldForm.setText("Karur");
                  miles = 4;
           Tfare= (miles*fare)+500;
           Dtax = (Tax*Tfare)/100;
           SubTotal = (Dtax + Tfare)*Pass;
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("Relus")|| jRadioButtonFirstClass1.isSelected()|| jRadioButtonReturn1.isSelected()||
               jRadioButtonEconomy1.isSelected()||
               jRadioButtonSingle1.isSelected()||(!(jTextFieldPassenger1.getText()== null) )){
      int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
       ...
       jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("Dindukal");
       jTextFieldClass.setText("Economy");
       jTextFieldTicketType.setText("Round Trip");
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("Velur");
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("VTSRBus") || jRadioButtonFirstClass1.isSelected()|| jRadioButtonReturn1.isSelected()||
               jRadioButtonEconomy1.isSelected()||
               jRadioButtonSingle1.isSelected()|| (!(jTextFieldPassenger1.getText()== null) ) ){
       int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
     
       jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("Avadi");
       jTextFieldClass.setText("First Class");
       jTextFieldTicketType.setText("Round Trip");
      jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("Erode");
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("Manjus") || jRadioButtonFirstClass1.isSelected()|| jRadioButtonReturn1.isSelected()||
               jRadioButtonEconomy1.isSelected()||
               jRadioButtonSingle1.isSelected()|| (!(jTextFieldPassenger1.getText()== null) )){
       int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
      
       jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("Salem");
       jTextFieldClass.setText("Economy");
       jTextFieldTicketType.setText("Round Trip");
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("Tambaram");
       ...
       jTextFieldTicketType.setText(null);
           ...
           else if(jComboBoxDestination.getSelectedItem().equals("Attur")|| jRadioButtonFirstClass1.isSelected()|| jRadioButtonReturn1.isSelected()||
               jRadioButtonEconomy1.isSelected()||
               jRadioButtonSingle1.isSelected()|| (!(jTextFieldPassenger1.getText()== null) )){
          int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
      ...
      jTextFieldDate2.setText(jDateChooser.getDate().toString());
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("TKS")|| jRadioButtonFirstClass1.isSelected()|| jRadioButtonReturn1.isSelected()||
               jRadioButtonEconomy1.isSelected()||
               jRadioButtonSingle1.isSelected()||(!(jTextFieldPassenger1.getText()== null) )){
       int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
      
       jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("Theni");
       jTextFieldClass.setText("Economy");
       jTextFieldTicketType.setText("One Way");
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("Tenkasi");
   ...
   if(jComboBoxTime.getSelectedItem().equals("11:30")){
       ...
       jTextFieldTicketType.setText(null);
           ...
           else if(jComboBoxDestination.getSelectedItem().equals("sps") || jRadioButtonFirstClass1.isSelected()|| jRadioButtonReturn1.isSelected()||
               jRadioButtonEconomy1.isSelected()||
               jRadioButtonSingle1.isSelected()|| (!(jTextFieldPassenger1.getText()== null) ) ){
      int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("Vinjus")|| jRadioButtonFirstClass1.isSelected()|| jRadioButtonReturn1.isSelected()||
               jRadioButtonEconomy1.isSelected()||
               jRadioButtonSingle1.isSelected()||(!(jTextFieldPassenger1.getText()== null) )){
       int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
   
       jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("Thoothukudi");
       jTextFieldClass.setText("Economy");
       jTextFieldTicketType.setText("One Way");
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("Madurai");
       ...
       jTextFieldTicketType.setText(null);
          ...
          else if(jComboBoxDestination.getSelectedItem().equals("MKS") || jRadioButtonFirstClass1.isSelected()|| jRadioButtonReturn1.isSelected()||
               jRadioButtonEconomy1.isSelected()||
               jRadioButtonSingle1.isSelected()||(!(jTextFieldPassenger1.getText()== null) ) ){
         int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("VNS") || jRadioButtonFirstClass1.isSelected()|| jRadioButtonReturn1.isSelected()||
               jRadioButtonEconomy1.isSelected()||
               jRadioButtonSingle1.isSelected()|| (!(jTextFieldPassenger1.getText()== null) ) ){
         int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
     
       jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("Puthupettai");
       jTextFieldClass.setText("First Class");
       jTextFieldTicketType.setText("One Way");
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("Madurai");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JDialog d=new JDialog(f,"Information");
        JLabel l=new JLabel("Your Ticket is Booked");
        d.add(l);
        d.setVisible(true);              
